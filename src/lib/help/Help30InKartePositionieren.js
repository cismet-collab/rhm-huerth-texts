      ...
      sectionContent={
        <div>
          ...
          <p>
            ...
            Weiterentwicklung des Hürther Kanalnetzes, wird nahezu das gesamte
            Stadtgebiet in Teilbereiche (GEP-Bereiche) eingeteilt. Die
            ...
            Zusätzlich haben wir weitere wichtige Hürther Bäche, die direkt in
            die Wupper oder die Düssel einmünden, als Alias für die zugehörigen
            GEP-Bereiche angelegt. Diese werden dann in der Form "Burgholzbach
            (im GEP 27 Cronenberg-West)" angezeigt.
          </p>
        </div>
      }
    />
